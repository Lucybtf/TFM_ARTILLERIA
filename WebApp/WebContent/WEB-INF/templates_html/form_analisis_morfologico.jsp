      ...
      <div class="page-header">
        ...
        <div class="col-md-8">
  		...
  		<form:form id="form" modelAttribute="informacionarma" action="/WebApp/form_medidas_dimensionales" method="post">
              ...
              <fieldset>
                  <form:label path="num_cuerpos">Número de cuerpos</form:label>
                  <form:input path="num_cuerpos"  class="col-sm-8  form-control" />
              </fieldset>
              <fieldset>
                <form:label path="forma_munones">Forma de muñones</form:label>
              ...
              <fieldset>
                  <form:label path="inscripcion_munon_izq">Inscripción del muñon izquierdo</form:label>
                  <form:input path="inscripcion_munon_izq"  class="col-sm-8  form-control"/>
              </fieldset> 
               <fieldset>
                  <form:label path="inscripcion_munon_der">Inscripción del muñon derecho</form:label></td>
              ...
              <fieldset>
                  <form:label path="anillo_union_brocal_astragalo">Astrágalo</form:label>
